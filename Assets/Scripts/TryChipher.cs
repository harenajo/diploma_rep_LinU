...
public class TryCipher : MonoBehaviour
{
    ...
    [Tooltip("Права колонка заміни / гіпотези: це мають бути TMP_InputField, а не TMP_Text.")]
    ...
    private void RefreshVigenereAlphabetPreview()
    {
        ...
        SetText(vigenereAlphabetResultText, "Після шифрування тут з'являться алфавіти, які використовувалися за ключем.");
    }
    ...
    private void RefreshVigenereAlphabetUsage(string input, string key, bool encrypt)
    {
        ...
        {
            SetText(vigenereAlphabetText, UpperAlphabet);
            SetText(vigenereAlphabetResultText, "Введіть ключ, щоб побачити використані алфавіти.");
            return;
        }
        ...
        {
            SetText(vigenereAlphabetText, UpperAlphabet);
            SetText(vigenereAlphabetResultText, "У тексті немає літер для шифрування.");
            return;
        }

        string usage = encrypt ? "Використані алфавіти для шифрування:\n" : "Використані алфавіти для дешифрування:\n";
        ...
        foreach (char keyLetter in usedKeyLetters)
        {
            ...
            usage += keyLetter + " → " + shiftedAlphabet + "\n";
        }
